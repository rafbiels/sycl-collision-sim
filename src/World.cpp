        ...
        Shape{Magnum::Primitives::planeSolid()}}
{
    ...
    m_walls[0].transformation(
        ...
        Magnum::Matrix4::scaling({0.5f*b.sizeZ(),0.5f*b.sizeY(),0.0f}));
    // Back wall
    m_walls[1].transformation(
        Magnum::Matrix4::translation({0.0f,0.0f,b.back()}) *
        Magnum::Matrix4::rotationY(0.0_degf) *
        Magnum::Matrix4::scaling({0.5f*b.sizeX(),0.5f*b.sizeY(),0.0f}));
    // Right wall
    ...
    m_walls[4].transformation(
        ...
        Magnum::Matrix4::scaling({0.5f*b.sizeX(),0.5f*b.sizeZ(),0.0f}));
    // Ceiling
