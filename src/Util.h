...
inline ClosestPointOnTriangleReturnValue closestPointOnTriangle(const std::array<sycl::float3,3>& triangle, const std::array<std::vector<float>,3>& vertices) {
    // ===========================================
    ...
    // Corrade::Utility::Debug{} << "closestPointOnTriangle\n>>> "
    //     << "distance = " << distance
    //     << ", bestPointOnTriangle(transformed) = " << Util::toMagnum(bestPointOnTriangle);
    ...
    // Corrade::Utility::Debug{} << "closestPointOnTriangle\n>>> "
    //     << "bestPointOnTriangle(real coords) = " << Util::toMagnum(bestPointOnTriangle);
